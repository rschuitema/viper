...
TEST_F(ViperboardGpioBTest, WriteBitLowSuccess)
{
    ViperResult_t result = VIPER_OTHER_ERROR;
    IGPIO_PortB* pGpio = pViper->GetGpioPortBInterface();
    uint8_t data[50] = {0xAA};
...
TEST_F(ViperboardGpioBTest, WriteBitIncorrectNrBytesTransactionFailure)
{
    ViperResult_t result = VIPER_OTHER_ERROR;
    IGPIO_PortB* pGpio = pViper->GetGpioPortBInterface();
    uint8_t data[50] = {0xAA};
...
TEST_F(ViperboardGpioBTest, WriteBitUsbErrorTransactionFailure)
{
    ViperResult_t result = VIPER_OTHER_ERROR;
    IGPIO_PortB* pGpio = pViper->GetGpioPortBInterface();
    uint8_t data[50] = {0xAA};
...
TEST_F(ViperboardGpioBTest, ReadBitHighSuccess)
{
    ViperResult_t result = VIPER_OTHER_ERROR;
    IGPIO_PortB* pGpio = pViper->GetGpioPortBInterface();
    bool bit_value = true;
...
TEST_F(ViperboardGpioBTest, ReadBitIncorrectNrBytesTransactionFailure)
{
    ViperResult_t result = VIPER_OTHER_ERROR;
    IGPIO_PortB* pGpio = pViper->GetGpioPortBInterface();
    bool bit_value = true;
...
TEST_F(ViperboardGpioBTest, ReadBitLibusbErrorTransactionFailure)
{
    ViperResult_t result = VIPER_OTHER_ERROR;
    IGPIO_PortB* pGpio = pViper->GetGpioPortBInterface();
    bool bit_value = true;
